...
main_game:
 ...
 buttonState2 = digitalRead(buttonPin2);
  ...
  if (cubod3 < 319) {
      ...
      LCD_Bitmap(cubod3, 160, 16, 16, tile);
      FillRect(cubod3 + 16, 160, 16, 24, 0x421b);
      LCD_Sprite(cubod3, 146, 19, 14, enemigo2, 2, animsp, 0, 0);
      FillRect(cubod3 + 19, 146, 19, 14, 0x421b);
  ...
  LCD_Bitmap(150, 219, 17, 17, prueba);
  LCD_Bitmap(167, 219, 17, 17, prueba);
...
void jump() {
  ...
  yB += caidaradioint;
  if (grounded == true) {
    LCD_Sprite(30, yB, 32, 36, megasalto1, 4, 0, 1, 1);
  ...
  if (grounded == false) {
    ...
    caidaradioint = int(caidaradio);
    uint8_t cubey1 = yB;
    uint8_t spikex1 = cubod;
    uint8_t cubex1 = 40;
    yB += caidaradioint;
    LCD_Sprite(30, yB, 32, 36, megasalto1, 4, animc, 1, 1);
    FillRect(30, 172, 32, 36, 0x421b);
...
//------------------------------------------------------------------
  ...
  if ((cubox2 >= cuboenex1) && (cubox1 <= cuboenex2) && (cuboy2 >= cuboeney1)) {
    gameover();
  }
}
void animate() {
